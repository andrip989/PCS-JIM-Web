...
{
    public partial class setupfloor : System.Web.UI.Page
    {
        sysConnection dbcon;
            ...
            if (cb.Checked)
            {
                ...
                if (objreader.Read())
                {
                    if (Convert.IsDBNull(objreader["floortype"]) == false)
                        floortype.Text = objreader["floortype"].ToString();
        ...
        protected void SaveClick(object sender, EventArgs e)
        {
            if (Page.IsValid && submit.Text == "Submit")
            {
                ...
                string sqlinsert = "INSERT INTO " + this.gettablename() + " (floortype" +
                                                                    ", description" +                                                                  
                                                                    ", createddate" +
                                                                    ", createdby) " +
                                                                    "VALUES(@floortype" +
                ...
                list.Add(new SqlParameter("@floortype", floortype.Text));
            ...
            else if (Page.IsValid && submit.Text == "Update")
            {
                ...
                string sql = "UPDATE " + this.gettablename() + " SET floortype=@floortype" +
