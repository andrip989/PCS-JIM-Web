<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="cleantrans.aspx.cs" Inherits="PCS_JIM_Web.Module.Submodule.cleantrans" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function validationSave()
        {
            ...
            var x = window.confirm("Are you sure want to clean room " + roomno + " ?")
            if (x) {
                return true;
            } else {
                return false;
        ...
        function validationCheckout() {
            ...
            var x = window.confirm("finish clean room = " + roomno + " ?")
            if (x) {
                return true;
            } else {
                return false;
...
<!--heder end here-->
       ...
       <div class="grid-form1">
	        <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<%= ResolveUrl("default.aspx") %>">Home</a><i class="fa fa-angle-right"></i>House Keeping <i class="fa fa-angle-right"></i> Clean Room Input</li>
            </ol>
        </div>
        <div class="grid-form1">
		<!--grid-->
