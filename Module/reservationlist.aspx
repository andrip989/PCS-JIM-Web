<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="reservationlist.aspx.cs" Inherits="PCS_JIM_Web.Module.reservationlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="default.aspx">Home</a><i class="fa fa-angle-right"></i>Reservation<i class="fa fa-angle-right"></i>List</li>
            </ol>
...
<div class="form-group">
  ...
  <div class="form-group">
    <div class="col-sm-offset-1 col-sm-10">
        ...
        <asp:Button ID="print" runat="server" Text="Print Rekap" CssClass="btn-danger btn" OnClick="print_Click"  />
    </div>
  </div>
					        ...
					        <div class="w3l-table-info">
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound" OnPageIndexChanging="GridView1_PageIndexChanging" >
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                                <asp:Label runat="server" Text="Print"></asp:Label>
                                            </HeaderTemplate>
                                            <ItemTemplate>                                                
                                                <asp:ImageButton id="btnchk" runat="server" OnClick="btnchk_Click" ImageUrl="~/images/report.png"  />
                                                <asp:HiddenField ID="recchk" runat="server" Value='<%# Eval("recid") %>'  />
                                                <asp:HiddenField ID="paramtransid" runat="server" Value='<%# Eval("transaksiid") %>'  />
                                            </ItemTemplate>
