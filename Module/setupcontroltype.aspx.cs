...
{
    public partial class setupcontroltype : System.Web.UI.Page
    {
        sysConnection dbcon;
        ...
        protected void chk_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (cb.Checked)
            {
                ...
                if (objreader.Read())
                {
                    if (Convert.IsDBNull(objreader["type"]) == false)
                        controltype.Text = objreader["type"].ToString();
                    ...
                    period.Text = objreader["period"].ToString();
                }
                objreader.Close();
                dbcon.closeConnection();
        ...
        protected void SaveClick(object sender, EventArgs e)
        {
            if (Page.IsValid && submit.Text == "Submit")
            {
                ...
                string sqlinsert = "INSERT INTO " + this.gettablename() + " (type" +
                                                                    ", description" +
                                                                    ", period" +
                                                                    ", createddate" +
                                                                    ", createdby " +
                ...
                list.Add(new SqlParameter("@type", controltype.Text));
                list.Add(new SqlParameter("@description", description.Text));
                list.Add(new SqlParameter("@period", Convert.ToInt32(period.Text)));
            ...
            else if (Page.IsValid && submit.Text == "Update")
            {
                ...
                string sql = "UPDATE " + this.gettablename() + " SET type=@type" +
